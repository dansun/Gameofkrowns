...
public class UppsalaImpl extends CountyImpl implements Uppsala<GameImpl, InfluenceImpl> {
	...
	public UppsalaImpl(AssetManager assetmanager) {
		this.countyMesh = assetmanager.get(GameofkrownsGame.UPPSALA_MODEL_ASSET, Mesh.class);
	}
