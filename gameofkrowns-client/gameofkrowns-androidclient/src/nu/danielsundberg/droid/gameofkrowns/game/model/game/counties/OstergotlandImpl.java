...
public class OstergotlandImpl extends CountyImpl implements Ostergotland<GameImpl,InfluenceImpl> {
	...
	public CountyName getCountyname() {
		return CountyName.OSTERGOTLAND;
	}
	...
	public OstergotlandImpl(AssetManager assetmanager) {
		this.countyMesh = assetmanager.get(GameofkrownsGame.OSTERGOTLAND_MODEL_ASSET, Mesh.class);
	}
