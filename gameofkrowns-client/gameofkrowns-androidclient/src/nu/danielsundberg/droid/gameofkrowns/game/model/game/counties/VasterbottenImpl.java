...
public class VasterbottenImpl extends CountyImpl implements Vasterbotten<GameImpl, InfluenceImpl> {
	...
	public CountyName getCountyname() {
		return CountyName.VASTERBOTTEN;
	}
	...
	public VasterbottenImpl(AssetManager assetmanager) {
		this.countyMesh = assetmanager.get(GameofkrownsGame.VASTERBOTTEN_MODEL_ASSET, Mesh.class);
	}
