...
public class DalarnaImpl extends CountyImpl implements Dalarna<GameImpl, InfluenceImpl> {
	...
	public DalarnaImpl(AssetManager assetmanager) {
		this.countyMesh = assetmanager.get(GameofkrownsGame.DALARNA_MODEL_ASSET, Mesh.class);
	}
