...
public class VarmlandImpl extends CountyImpl implements Varmland<GameImpl, InfluenceImpl> {
...
private static final long serialVersionUID = 1L;
	...
	public VarmlandImpl(AssetManager assetmanager) {
		this.countyMesh = assetmanager.get(GameofkrownsGame.VARMLAND_MODEL_ASSET, Mesh.class);
	}
}
