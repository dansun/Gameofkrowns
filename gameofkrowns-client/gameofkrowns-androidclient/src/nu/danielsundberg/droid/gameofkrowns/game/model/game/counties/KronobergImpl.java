...
public class KronobergImpl extends CountyImpl implements Kronoberg<GameImpl,InfluenceImpl> {
	...
	public KronobergImpl(AssetManager assetmanager) {
		this.countyMesh = assetmanager.get(GameofkrownsGame.KRONOBERG_MODEL_ASSET, Mesh.class);
	}
