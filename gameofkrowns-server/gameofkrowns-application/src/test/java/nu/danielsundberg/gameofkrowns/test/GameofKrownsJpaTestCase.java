package nu.danielsundberg.gameofkrowns.test;
...
public abstract class GameofKrownsJpaTestCase extends GameofKrownsApplicationTestCase {
	...
	public static void setUpDataBase() throws Exception {
		...
		testPersistenceProperties.put("hibernate.archive.autodetection","class");
		entityManagerFactory = Persistence.createEntityManagerFactory("gameofkrownsPersistenceUnit", testPersistenceProperties);
