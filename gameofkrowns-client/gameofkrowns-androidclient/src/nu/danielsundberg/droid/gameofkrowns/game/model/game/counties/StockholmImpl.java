...
public class StockholmImpl extends CountyImpl implements Stockholm<GameImpl, InfluenceImpl> {
	...
	public StockholmImpl(AssetManager assetmanager) {
		this.countyMesh = assetmanager.get(GameofkrownsGame.STOCKHOLM_MODEL_ASSET, Mesh.class);
	}
