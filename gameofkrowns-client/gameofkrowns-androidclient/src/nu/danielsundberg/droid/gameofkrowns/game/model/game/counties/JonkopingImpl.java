...
public class JonkopingImpl extends CountyImpl implements Jonkoping<GameImpl,InfluenceImpl> {
	...
	public JonkopingImpl(AssetManager assetmanager) {
		this.countyMesh = assetmanager.get(GameofkrownsGame.JONKOPING_MODEL_ASSET, Mesh.class);
	}
