package nu.danielsundberg.droid.gameofkrowns;
...
public class WebService extends AsyncTask<Void, Void, String> {
    ...
    public WebService(String serviceName, String mName, Map<String, String> params, ICallbackHandler hndl, String method){
    ...
    public String webGet(String methodName, Map<String, String> params) {
        ...
        try {
            ...
            if (e != null && e.getMessage() != null) Log.e(WSC_TAG, e.getMessage());
            else if (e != null) Log.e(WSC_TAG, e.toString());
            else Log.e(WSC_TAG, "NULL Exception");
        }
    ...
    protected String doInBackground(Void... prs) {
        if (method.equals(GET_METHOD))
            return webGet(methodName, params);
        else if (method.equals(POST_METHOD)) {
            return webInvoke(methodName, params);
        } else {
