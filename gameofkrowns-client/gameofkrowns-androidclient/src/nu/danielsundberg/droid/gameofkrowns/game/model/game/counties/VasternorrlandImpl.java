...
public class VasternorrlandImpl extends CountyImpl implements Vasternorrland<GameImpl, InfluenceImpl> {
	...
	public CountyName getCountyname() {
		return CountyName.VASTERNORRLAND;
	}
	...
	public VasternorrlandImpl(AssetManager assetmanager) {
		this.countyMesh = assetmanager.get(GameofkrownsGame.VASTERNORRLAND_MODEL_ASSET, Mesh.class);
	}
