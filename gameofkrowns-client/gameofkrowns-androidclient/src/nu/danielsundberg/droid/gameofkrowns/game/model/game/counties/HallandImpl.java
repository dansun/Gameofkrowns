...
public class HallandImpl extends CountyImpl implements Halland<GameImpl, InfluenceImpl> {
	...
	public HallandImpl(AssetManager assetmanager) {
		this.countyMesh = assetmanager.get(GameofkrownsGame.HALLAND_MODEL_ASSET, Mesh.class);
	}
