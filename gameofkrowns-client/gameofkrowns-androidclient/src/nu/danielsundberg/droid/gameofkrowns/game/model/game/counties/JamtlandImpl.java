...
public class JamtlandImpl extends CountyImpl implements Jamtland<GameImpl,InfluenceImpl> {
	...
	public JamtlandImpl(AssetManager assetmanager) {
		this.countyMesh = assetmanager.get(GameofkrownsGame.JAMTLAND_MODEL_ASSET, Mesh.class);
	}
