...
public class GotlandImpl extends CountyImpl implements Gotland<GameImpl, InfluenceImpl> {
	...
	public GotlandImpl(AssetManager assetmanager) {
		this.countyMesh = assetmanager.get(GameofkrownsGame.GOTLAND_MODEL_ASSET, Mesh.class);
	}
