...
public class KalmarImpl extends CountyImpl implements Kalmar<GameImpl, InfluenceImpl> {
...
private static final long serialVersionUID = 1L;
	...
	public KalmarImpl(AssetManager assetmanager) {
		this.countyMesh = assetmanager.get(GameofkrownsGame.KALMAR_MODEL_ASSET, Mesh.class);
	}
